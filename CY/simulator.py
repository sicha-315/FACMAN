...
class ProcessSimulator:
    def __init__(self, simulation_speed=1):
        ...
        self.total_failure_time = 0.0   # 전체 고장 시간(초)
    ...
    def run_step(self):
        speed = random.randint(2, 10)  # 작업 속도 (2~10초 사이)
        print(f"[작업 시작] {speed}초 동안 작업 수행 중...")
    ...
    def repair(self):
        print("[수리 중] 약 60초 소요...")
        repair_time = np.random.normal(60, 10)  # 수리 시간 (30~90초 사이)
